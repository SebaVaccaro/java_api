...
public class InstanciaComunUI {

    private final Scanner scanner = new Scanner(System.in);
    private final InstanciaComunFacade facade;

    public InstanciaComunUI() throws SQLException {
    ...
    private void buscarPorInstancia() {
        ...
        try {
            InstanciaComun ic = facade.obtenerPorInstancia(id);
    ...
    private void eliminarPorInstancia() {
        ...
        try {
            boolean eliminado = facade.eliminarPorInstancia(id);
    ...
    public static void main(String[] args) {
        try {
            InstanciaComunUI ui = new InstanciaComunUI();
            ui.menuInstanciasComunes();
        } catch (SQLException e) {
            System.out.println("❌ No se pudo iniciar la UI: " + e.getMessage());
        }
    }
}
